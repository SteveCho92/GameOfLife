...
class DoubleLinkedListTest {
    ...
    /**
     * Generating multiple iterators for a linked list should create independent
     * iterator objects. Since iterators cannot add or remove from a linked
     * list, it seems safe to permit multiple iterators to view the list
     * independently.
     */
    @Test
    ...
    /**
     * When removing an element from the front of an empty list, the list should
     * throw a CouldNotRemoveException. We can't remove anything from an empty
     * list.
     */
    @Test
    ...
    /**
     * After removing an element from the front of the list, we need to make
     * sure that head and tail point to null, that size equals zero, and the
     * element returned is the element we expected.
     * 
     * @throws CouldNotAddException
     *             addToFront error
     * @throws CouldNotRemoveException
     *             removeFromFront error
     */
    @Test
    ...
    /**
     * After many non-null elements to the end of a new empty list, the new size
     * should be correct, the list's head should point to the first element
     * added, and the list's tail should point to the most recently added
     * element..
     * 
     * @throws CouldNotAddException
     * @throws CouldNotRemoveException
    ...
    /**
     * When removing an element from the end of an empty list, the list should
     * throw a CouldNotRemoveException. We can't remove anything from an empty
     * list.
     */
    @Test
    ...
    /**
     * After removing an element from the end of the list, we need to make sure
     * that head and tail point to null, that size equals zero, and the element
     * returned is the element we expected.
     * 
     * @throws CouldNotAddException
     *             addToFront error
     * @throws CouldNotRemoveException
     ...
     * the new size should be correct, the list's head should still point to the
     * first element added, and the list's tail should point to the the end of
     * the list.
     * 
     * @throws CouldNotAddException
     * @throws CouldNotRemoveException
